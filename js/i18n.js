...
const PTS_I18N = {
  en: {
    ...
    "fd.eyebrow": "The founders",
    "fd.t1": "The people behind",
    "fd.t2": "the pulse.",
    "fd.n1": "Zohir Hammouda",
    "fd.r1": "Co-Founder · Software & Technology",
    "fd.b1": "Leads PT Soft's engineering — system architecture, backend infrastructure, and the technical core of every product.",
    "fd.n2": "Younes Itbirene",
    "fd.r2": "Co-Founder · Management & Strategy",
    "fd.b2": "Leads the company's direction — management, marketing, strategy, and finance.",
  ...
  fr: {
    ...
    "fd.eyebrow": "Les fondateurs",
    "fd.t1": "Les visages derrière",
    "fd.t2": "le pouls.",
    "fd.n1": "Zohir Hammouda",
    "fd.r1": "Cofondateur · Logiciels & Technologie",
    "fd.b1": "Dirige l'ingénierie de PT Soft — architecture des systèmes, infrastructure backend et cœur technique de chaque produit.",
    "fd.n2": "Younes Itbirene",
    "fd.r2": "Cofondateur · Gestion & Stratégie",
    "fd.b2": "Dirige le cap de l'entreprise — gestion, marketing, stratégie et finances.",
  ...
  ar: {
    ...
    "fd.t2": "النبض.",
    "fd.n1": "زهير حمودة",
    "fd.r1": "شريك مؤسس · البرمجيات والتقنية",
    "fd.b1": "يقود هندسة PT Soft — بنية الأنظمة والبنية التحتية الخلفية والنواة التقنية لكل منتج.",
    "fd.n2": "يونس إتبيرن",
    "fd.r2": "شريك مؤسس · الإدارة والاستراتيجية",
    "fd.b2": "يقود دفّة الشركة — الإدارة والتسويق والاستراتيجية والمالية.",
