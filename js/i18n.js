...
const PTS_I18N = {
  en: {
    ...
    "fd.b1": "Leads PT Soft's engineering — architecture, infrastructure, and technical core.",
  ...
  fr: {
    ...
    "fd.b1": "Dirige l'ingénierie de PT Soft — architecture, infrastructure et cœur technique.",
    "fd.n2": "Younes Itbirene",
  ...
  ar: {
    ...
    "fd.b1": "يقود هندسة PT Soft — البنية والنواة التقنية.",
    "fd.n2": "يونس إتبيرن",
